...
/** enum ipa_resource_type - IPA resource types for an SoC having IPA v6.0 */
...
/* Resource groups used for an SoC having IPA v6.0 */
...
/* QSB configuration data for an SoC having IPA v6.0 */
...
/* Endpoint configuration data for an SoC having IPA v6.0 */
...
/* Source resource configuration data for an SoC having IPA v6.0 */
...
/* Destination resource configuration data for an SoC having IPA v6.0 */
...
/* Resource configuration data for an SoC having IPA v6.0 */
...
/* IPA-resident memory region data for an SoC having IPA v6.0 */
...
/* Memory configuration data for an SoC having IPA v6.0 */
...
/* Clock and interconnect configuration data for an SoC having IPA v6.0 */
...
/* Configuration data for an SoC having IPA v6.0. */
const struct ipa_data ipa_data_v6_0 = {
	.version		= IPA_VERSION_6_0,
