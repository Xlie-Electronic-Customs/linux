...
static const struct drm_display_mode panel_samsung_amb670yf07_1440_3216_dsc_mode = {
...
{
	return drm_connector_helper_get_modes_fixed(connector, &panel_samsung_amb670yf07_1440_3216_dsc_mode);
}
